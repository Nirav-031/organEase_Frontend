...
export default function RegisterDonor() {
	...
	const { values, errors, handleChange, handleSubmit } = useFormik({
		...
		onSubmit: (value) => {
			...
			axios
				.post(`${url}/DonorRegistrationPost/`, {
					...value,
					DOB: value.bDate,
					bloodtype: value.blood,
					guardian_mobile_number: value.gNumber,
					guardian_name:value.gName,
					hospital_id:12,
				...
				.then((res) => {
					...
					//console.log(res.data.mobile_number[0]);
					setLoading(false);
				})
				.catch((err) => {
					console.error(err);
			...
			<div className="w-[99%] h-[95%] bg-white  rounded-2xl ">
				...
				{isLoading ? (
					...
					<form onSubmit={handleSubmit}>
						<div className="w-full grid grid-cols-2 p-5 space-y-2 overflow-y-auto max-h-[500px]">
							<div className="">
